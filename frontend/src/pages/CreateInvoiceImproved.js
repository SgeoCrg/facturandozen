...
const CreateInvoice = () => {
  ...
  const addLine = () => {
    if (!currentLine.description || currentLine.quantity <= 0 || currentLine.price <= 0) {
      setError('Completa descripción, cantidad y precio');
      descriptionRef.current?.focus();
      return;
    }
        ...
        <Card className="mb-4 scale-in" style={{ animationDelay: '0.1s' }}>
          ...
          <Card.Body>
            ...
            <div className="border rounded p-3 bg-light">
              ...
              <div className="row g-2 invoice-lines">
                ...
                <div className="col-6 col-md-2">
                  ...
                  >
                    ...
                    <span className="d-none d-md-inline">Añadir</span>
                  </Button>
                </div>
              </div>
          ...
          <Card.Body>
            <div className="row">
              <div className="col-12 col-md-8">
                {lines.length === 0 && (
                  <Alert variant="warning" className="mb-3 mb-md-0">
            ...
            <div className="d-grid d-md-flex justify-content-md-end gap-2 mt-3">
              <Button 
                variant="secondary" 
